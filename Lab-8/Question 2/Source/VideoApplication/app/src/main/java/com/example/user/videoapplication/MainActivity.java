...
public class MainActivity extends GvrActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onCardboardTrigger() {
        Toast.makeText(this, "Cardboard Trigger is pulled", Toast.LENGTH_SHORT).show();
    }
