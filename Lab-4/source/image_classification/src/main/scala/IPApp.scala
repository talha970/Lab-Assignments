...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("cat", "horses", "dog")
  ...
  def decisiontreeModel(sc: SparkContext): Unit = {
   ...
   // val sameModel = DecisionTreeModel.load(sc, IPSettings.RANDOM_FOREST_PATH)
  }
  ...
  def main(args: Array[String]) {
   ...
   decisiontreeModel(sc)
    ...
    println("SIZE OF THE GODDAMN array "+testImagesArray.size);
